...
public class APIDTO   {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, apiId, provider, name, version, context, contextTemplate, policy, apiType, status, organization, isDefaultVersion, apiPolicies, urlMappings, securityScheme);
  }
